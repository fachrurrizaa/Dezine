...
export default function CategoryItem({id, thumbnails, name, postCount }) {
  return (
    <div className="card w-72 h-[260px] bg-slate-50 shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:cursor-pointer hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] transition-all duration-300 ease-in-out">
